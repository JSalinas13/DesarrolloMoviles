...
import 'package:proyecto/colors.dart';
...
class BeerCard extends StatelessWidget {
  ...
  BeerCard(this.drink, this.pageOffset, this.index);
  ...
  Widget buildBurImage(double cardWidth, Size size) {
    return Positioned(
